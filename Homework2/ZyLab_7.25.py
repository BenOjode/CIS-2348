...
# Function that determines change values and returns the corresponding values
...
# Test function asling for input, refers to the main function and calls upon the exact_change function
